...
/**
 * Servlet implementation class ClearHistConfirm
 */
@WebServlet("/ClearHistConfirm")
public class ClearHistConfirm extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClearHistConfirm() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		quiz.clearQuizHistory();
		RequestDispatcher dispatch = request.getRequestDispatcher("historyCleared.jsp");
		dispatch.forward(request, response);
	}
